{
    "serverAddress": "study-guide-test-query.cdpu1q7bfaps.us-west-2.rds.amazonaws.com:3306",
    ...
    "checksPerformed": [
        ...
        },
        {
            ...
            "detectedProblems": [
                ...
                {
                    "level": "Warning",
                    "dbObject": "study_guide.capp_assignment_metadata.assignment_uuid",
                    "description": "column's default character set: utf8"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.capp_qna_metadata.qna_uuid",
                    "description": "column's default character set: utf8"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.capp_qna_metadata.assignment_uuid",
                    "description": "column's default character set: utf8"
                }
            ]
        },
        ...
        },
        {
            ...
            "detectedProblems": [
                ...
                },
                {
                    ...
                    "description": " of 3 session(s) does not contain either NO_ZERO_DATE or NO_ZERO_IN_DATE which allows insertion of zero dates"
                },
                {
                    "level": "Warning",
                    "dbObject": "review.lookup.created_time",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "review.reasons.created_time",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "review.user_entity_review.created_time",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "review.user_entity_review.archived_time",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.asset_type.created_date",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.qna_metadata.created_date",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.tbs_metadata.created_date",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.user_assets.created_date",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                },
                {
                    "level": "Warning",
                    "dbObject": "study_guide.user_directory.created_date",
                    "description": "column has zero default value: 0000-00-00 00:00:00"
                }
            ]
        },
