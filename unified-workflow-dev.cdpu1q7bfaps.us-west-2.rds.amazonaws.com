{
    "serverAddress": "unified-workflow-dev.cdpu1q7bfaps.us-west-2.rds.amazonaws.com:3306",
    "serverVersion": "5.7.43-log - Source distribution",
        ...
        },
        {
            ...
            "detectedProblems": [
                ...
                },
                {
                    ...
                    "description": " of 158 session(s) does not contain either NO_ZERO_DATE or NO_ZERO_IN_DATE which allows insertion of zero dates"
                }
            ]
        },
        {
